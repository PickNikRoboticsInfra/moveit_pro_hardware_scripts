...
To wrap your own objective into a forever-loop driver, import `cd_objective_lib` from `/usr/lib/moveit-pro-scripts` and call `run_objectives_forever([...])` with the Objective names you want to chain.
